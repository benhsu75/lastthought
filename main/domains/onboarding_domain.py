...
def send_finished_onboarding_message(profile):
    finished_onboarding_message = "You're all set! You can view your thoughts anytime by tapping View Thoughts in the bottom left menu or go to {}".format(constants.BASE_HEROKU_URL)
